			...
			<aside
				...
				<form
					...
					<RadioGroup
						...
						onChange={(option: OptionType) =>
							handleOptionChange('fontSizeOption', option)
						}
						title='Размер шрифта'
					/>
					...
					<Select
						...
						onChange={(option: OptionType) =>
							handleOptionChange('fontColor', option)
						}
						//onClose: {}
						title='Цвет шрифта'
					/>
					...
					<Select
						...
						onChange={(option: OptionType) =>
							handleOptionChange('backgroundColor', option)
						}
						//onClose: {}
						title='Цвет фона'
					/>
					...
					<Select
						...
						onChange={(option: OptionType) =>
							handleOptionChange('contentWidth', option)
						}
						//onClose: {}
